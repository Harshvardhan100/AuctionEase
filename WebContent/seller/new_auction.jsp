			...
			<div class="row">
				<div class="col-md-5 mx-auto">
					...
					<form action="../AdminAddItem" method="post"
						...
						<div class="form-group row">
							<label for="sellerName">Seller Id</label> <input
								name="sellerId" type="text" class="form-control"
								id="sellerName" placeholder="Enter Seller Id">
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							<label for="endDate">Status</label> <select name="status"
								type="date" class="form-control" id="istatus">
								<option selected>--select---</option>
								<option value="Active">Active</option></options>
								<option value="Active">Inactive</option></options>
								</select>
						</div>
						<div class="form-group row">
